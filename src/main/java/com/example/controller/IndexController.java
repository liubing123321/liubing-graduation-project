...
public class IndexController {
    ...
    @ResponseBody
    public String profile(@PathVariable("userId") int userId,/*路径*/
                          @PathVariable("groupId") String groupId,
                          @RequestParam("type") int type,/*参数*/
    ...
    public String request(Model model, HttpServletResponse response, HttpServletRequest request, HttpSession httpSession,
        ...
        //response.getOutputStream().write();写验证码 图片或者二进制的流
        return sb.toString();
    }
