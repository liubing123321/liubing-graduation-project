...
//关注用户
    ...
    public String followUser(@RequestParam("userId") int userId) {
        ...
        boolean ret = followService.follow(hostHolder.getUser().getId(), EntityType.ENTITY_USER, userId);//当前用户关注用户
    ...
    public String followers(Model model, @PathVariable("uid") int userId) {//路径里的变量要用@pathVariable，userId代表所点击查看的用户id
