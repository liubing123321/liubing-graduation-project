...
import com.example.service.SensitiveService;
...
@SpringApplicationConfiguration(classes = WenApplication.class)
@Sql("/init-schema.sql")
/*
public class InitDatabaseTests {
	...
	public void initDatabase() {
		...
		for(int i=0;i<11;i++){
			...
			question.setContent(String.format("Babababababa Content%d",i));
